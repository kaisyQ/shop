...
export const fetchUsers = createAsyncThunk(
    ...
    async () => {
        try {
            const response = await fetch(`https://bmfurniture.ca/users`, {
                method: "GET",
                headers: {
...
export const fetchUserById = createAsyncThunk(
    ...
    async (id: string) => {
        try {
            const response = await fetch(`https://bmfurniture.ca/${id}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                },
...
export const fetchToDeleteUser = createAsyncThunk(
    ...
    async (id: string) => {
        try {
            const response = await fetch(`https://bmfurniture.ca/users/${id}`, {
                method: "DELETE",
                credentials: "include"
            })
